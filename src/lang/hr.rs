...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na VexeoSoporte mrežu..."),
        ...
        ("install_tip", "Zbog UAC-a VexeoSoporte ne može u nekim slučajevima raditi pravilno. Da biste prevazišli UAC, kliknite na tipku ispod da instalirate VexeoSoporte na sustav."),
        ("Click to upgrade", "Klik za nadogradnju"),
        ("Configure", "Konfiguracija"),
        ("config_acc", "Da biste daljinski kontrolirali radnu površinu, VexeoSoporte-u trebate dodijeliti prava za \"Pristupačnost\"."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, VexeoSoporte-u trebate dodijeliti prava za \"Snimanje zaslona\"."),
        ...
        ("android_input_permission_tip1", "Da bi ste daljinski uređaj kontrolirali vašim Android uređajem preko miša ili na dodir, trebate dopustiti VexeoSoporte-u da koristi servis \"Pristupačnost\"."),
        ("android_input_permission_tip2", "Molimo prijeđite na sljedeću stranicu podešavanja sustava, pronađite i unesite [Instalirani servisi], uključite servis [VexeoSoporte Input]."),
        ...
        ("Language", "Jezik"),
        ("Keep RustDesk background service", "Zadrži VexeoSoporte kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizaciju baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite onemogućiti ovu funkciju, molimo idite na sljedeću stranicu za podešavanje VexeoSoporte aplikacije, pronađite i uđite u [Baterija], onemogućite [Neograničeno]"),
        ...
        ("Show RustDesk", "Prikaži VexeoSoporte"),
        ...
        ("config_input", "Za upravljanje udaljenom radnom površinom pomoću tipkovnice, morate dodijeliti VexeoSoporteu dopuštenje \"Nadzor unosa\"."),
        ("config_microphone", "Da biste razgovarali na daljinu, morate dopustiti VexeoSoporteu \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "Još uvijek zahtijeva da udaljeni korisnik klikne OK u UAC prozoru pokrenutog VexeoSoportea."),
        ...
        ("verify_rustdesk_password_tip", "Provjera lozinke za VexeoSoporte"),
        ...
        ("scam_text1", "Ako razgovarate telefonom s nekim koga NE POZNAJETE i NE VJERUJETE tko vas je zamolio da koristite i pokrenete VexeoSoporte, nemojte nastavljati razgovor i odmah spustite slušalicu."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Ažurirajte VexeoSoporte Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "Na vašem uređaju je omogućen SELinux, što može spriječiti VexeoSoporte da pravilno radi kao upravljana strana."),
        ...
        ("powered_by_me", "Pokreće VexeoSoporte"),
        ...
        ("allow-only-conn-window-open-tip", "Dopusti vezu samo ako je prozor VexeoSoportea otvoren"),
        ...
        ("floating_window_tip", "Pomaže u održavanju pozadinskog servisa VexeoSoportea"),
        ...
        ("About RustDesk", "O VexeoSoporteu"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Molimo ažurirajte VexeoSoporte klijent na verziju {} ili noviju na udaljenoj strani!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Prema zadanim postavkama, VexeoSoporte provjerava certifikat poslužitelja za protokole koji koriste TLS.\nKada je ova opcija omogućena, VexeoSoporte će u slučaju neuspjele provjere preskočiti korak provjere i nastaviti."),
        ("Disable UDP", "Onemogući UDP"),
        ("disable-udp-tip", "Određuje hoće li se koristiti samo TCP.\nKada je ova opcija omogućena, VexeoSoporte više neće koristiti UDP 21116, već će umjesto toga koristiti TCP 21116."),
        ("server-oss-not-support-tip", "NAPOMENA: VexeoSoporte poslužitelj OSS ne uključuje ovu značajku."),
