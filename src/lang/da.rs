...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter forbindelse til VexeoSoporte-netværket..."),
        ...
        ("install_tip", "På grund af UAC kan VexeoSoporte ikke fungere korrekt i nogle tilfælde på fjernskrivebordet. For at undgå UAC skal du klikke på knappen nedenfor for at installere VexeoSoporte på systemet"),
        ("Click to upgrade", "Klik for at opgradere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For at kontrollere dit skrivebord på afstand skal du give VexeoSoporte \"Access \" Rettigheder."),
        ("config_screen", "For at kunne få adgang til dit skrivebord langtfra, skal du give VexeoSoporte \"skærmstøtte \" tilladelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhed kan kontrollere din Android-enhed via mus eller berøring, skal du give VexeoSoporte mulighed for at bruge tjenesten \"tilgængelighed \"."),
        ("android_input_permission_tip2", "Gå til den næste systemindstillingsside, søg og indtast [installerede tjenester], tænd for [VexeoSoporte Input] tjenesten."),
        ...
        ("Turned off", "Slukket"),
        ("Language", "Sprog"),
        ("Keep RustDesk background service", "Behold VexeoSoporte baggrundstjeneste"),
        ("Ignore Battery Optimizations", "Ignorér betteri optimeringer"),
        ("android_open_battery_optimizations_tip", "Hvis du ønsker at slukke for denne funktion, åbn VexeoSoporte appens indstillinger, tryk på [Batteri], og fjern flueben ved [Uden begrænsninger]"),
        ...
        ("Show RustDesk", "Vis VexeoSoporte"),
        ("This PC", "Denne PC"),
        ("or", "eller"),
        ("Elevate", "Elevér"),
        ...
        ("software_render_tip", "Hvis du bruger et Nvidia grafikkort på Linux, og fjernskrivebordsvinduet lukker ned med det samme efter forbindelsen er oprettet, kan det hjælpe at skifte til Nouveau open-source driveren, og aktivere software rendering. Et genstart af VexeoSoporte er nødvendigt."),
        ("Always use software rendering", "Brug altid software rendering"),
        ("config_input", "For at styre fjernskrivebordet med tastaturet, skal du give VexeoSoporte rettigheder til at optage tastetryk"),
        ("config_microphone", "For at tale sammen over fjernstyring, skal du give VexeoSoporte rettigheder til at optage lyd"),
        ...
        ("still_click_uac_tip", "Kræver stadigvæk at fjernbrugeren skal trykke OK på UAC vinduet ved kørsel af VexeoSoporte."),
        ...
        ("verify_rustdesk_password_tip", "Bekræft VexeoSoporte adgangskode"),
        ...
        ("scam_text1", "Hvis du taler telefon med en person du IKKE kender, og IKKE stoler på, som har bedt dig om at bruge VexeoSoporte til at forbinde til din PC, stop med det samme, og læg på omgående."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Opgradér venligst VexeoSoporte Server Pro til version {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktiveret på din enhed, som kan forhindre VexeoSoporte i at køre normalt."),
        ...
        ("powered_by_me", "Drives af VexeoSoporte"),
        ...
        ("preset_password_warning", "Denne brugertilpassede udgave har en forudbestemt adgangskode. Alle der kender til denne adgangskode, kan få fuld adgang til din enhed. Hvis du ikke forventede dette, bør du afinstallere denne udgave af VexeoSoporte med det samme."),
        ...
        ("allow-only-conn-window-open-tip", "Tillad kun fjernforbindelser hvis VexeoSoporte vinduet er synligt"),
        ...
        ("floating_window_tip", "Det hjælper på at VexeoSoporte baggrundstjenesten kører"),
        ...
        ("About RustDesk", "Om VexeoSoporte"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Opgrader venligst VexeoSoporte-klienten til version {} eller nyere på fjernsiden!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verificerer VexeoSoporte servercertifikatet for protokoller, der bruger TLS.\nNår denne indstilling er aktiveret, vil VexeoSoporte springe verificeringstrinnet over og fortsætte, hvis verificeringen mislykkes."),
        ("Disable UDP", "Deaktivér UDP"),
        ("disable-udp-tip", "Bestemmer, om der kun skal bruges TCP.\nNår denne indstilling er aktiveret, vil VexeoSoporte ikke længere bruge UDP 21116; i stedet bruges TCP 21116."),
        ("server-oss-not-support-tip", "BEMÆRK: VexeoSoporte server OSS indeholder ikke denne funktion."),
