...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Për shkak të UAC, VexeoSoporte nuk mund të punoj sic duhet si nje remote në distancë në disa raste. Për të shamngur UAC, ju lutem klikoni butonin më poshtë për të instaluar VexeoSoporte në sistem."),
        ("Click to upgrade", "Klikoni për përmirësim"),
        ("Configure", "Koniguro"),
        ("config_acc", "Për të kontrolluar Desktopin tuaj nga distanca, duhet të jepni leje VexeoSoporte \"Aksesueshmëri\"."),
        ("config_screen", "Për të aksesuar Desktopin tuaj nga distanca, duhet ti jepni lejet VexeoSoporte \"Regjistrimin e ekranit\"."),
        ...
        ("android_input_permission_tip1", "Në mënyrë që një pajisje në distancë të kontrollojë pajisjen tuaj Android nëpërmjet mausit ose prekjes, duhet të lejoni VexeoSoporte të përdorë shërbimin."),
        ("android_input_permission_tip2", "Ju lutemi shkoni në faqen tjetër të cilësimeve të sistemit, gjeni dhe shtypni [Shërbimet e Instaluara], aktivizoni shërbimin [VexeoSoporte Input]"),
        ...
        ("Turned off", "I fikur"),
        ("Language", "Gjuha"),
        ("Keep RustDesk background service", "Mbaje shërbimin e sfondit të VexeoSoporte"),
        ("Ignore Battery Optimizations", "Injoro optimizimet e baterisë"),
        ("android_open_battery_optimizations_tip", "Nëse dëshironi ta çaktivizoni këtë veçori, ju lutemi shkoni te faqja tjetër e cilësimeve të aplikacionit VexeoSoporte, gjeni dhe shtypni [Batteri], hiqni zgjedhjen [Te pakufizuara]"),
        ...
        ("Show RustDesk", "Shfaq VexeoSoporte"),
        ("This PC", "Ky PC"),
        ("or", "ose"),
        ("Elevate", "Ngritja"),
        ...
        ("config_input", "Për të kontrolluar desktopin në distancë me tastierë, duhet t'i jepni VexeoSoporte lejen \"Monitorimi i hyrjes\"."),
        ("config_microphone", "Për të folur në distancë, duhet t'i jepni VexeoSoporte lejen \"Regjistro audio\"."),
        ...
        ("still_click_uac_tip", "Ende kërkon që përdoruesi në distancë të klikojë OK në dritaren UAC të VexeoSoporte që po funksionon."),
        ...
        ("verify_rustdesk_password_tip", "Verifiko fjalëkalimin e VexeoSoporte"),
        ...
        ("scam_text1", "Nëse jeni në telefon me dikë që NUK e njihni DHE NUK i BESONI, i cili ju ka kërkuar të përdorni VexeoSoporte dhe të nisni shërbimin, mos vazhdoni dhe mbyllni telefonin menjëherë."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Ju lutemi përmirësoni VexeoSoporte Server Pro në versionin {} ose më të ri!"),
        ...
        ("selinux_tip", "SELinux është i aktivizuar në pajisjen tuaj, gjë që mund të pengojë VexeoSoporte të funksionojë siç duhet si anë e kontrolluar."),
        ...
        ("powered_by_me", "Mundësuar nga VexeoSoporte"),
        ...
        ("allow-only-conn-window-open-tip", "Lejo lidhjen vetëm nëse dritarja e VexeoSoporte është e hapur"),
        ...
        ("floating_window_tip", "Ndihmon për të mbajtur shërbimin në sfond të VexeoSoporte"),
        ...
        ("About RustDesk", "Rreth VexeoSoporte"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Ju lutemi përmirësoni klientin VexeoSoporte në versionin {} ose më të ri në anën në distancë!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Si parazgjedhje, VexeoSoporte verifikon certifikatën e serverit për protokollet që përdorin TLS.\nMe këtë opsion të aktivizuar, VexeoSoporte do të kthehet duke kapërcyer hapin e verifikimit dhe do të vazhdojë në rast dështimi të verifikimit."),
        ("Disable UDP", "Çaktivizo UDP"),
        ("disable-udp-tip", "Kontrollon nëse do të përdoret vetëm TCP.\nKur ky opsion është i aktivizuar, VexeoSoporte nuk do ta përdorë më UDP 21116, në vend të tij do të përdoret TCP 21116."),
        ("server-oss-not-support-tip", "SHËNIM: VexeoSoporte server OSS nuk e përfshin këtë veçori."),
