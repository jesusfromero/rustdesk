...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do VexeoSoporte..."),
        ...
        ("install_tip", "Devido ao UAC, o VexeoSoporte não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o VexeoSoporte no sistema."),
        ("Click to upgrade", "Iniciar atualização"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao VexeoSoporte permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao VexeoSoporte permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o VexeoSoporte use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [VexeoSoporte Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep RustDesk background service", "Manter o serviço do VexeoSoporte executando em segundo plano"),
        ...
        ("Show RustDesk", "Exibir VexeoSoporte"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do VexeoSoporte."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do VexeoSoporte."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do VexeoSoporte."),
        ...
        ("verify_rustdesk_password_tip", "Verifique a senha do VexeoSoporte"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o VexeoSoporte e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualize o VexeoSoporte Server Pro para a versão {} ou superior."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o VexeoSoporte funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por VexeoSoporte"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do VexeoSoporte estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço VexeoSoporte em segundo plano"),
        ...
        ("About RustDesk", "Sobre VexeoSoporte"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente VexeoSoporte para a versão {} ou superior no lado remoto."),
        ...
        ("allow-insecure-tls-fallback-tip", "Por padrão, o VexeoSoporte verifica o certificado do servidor para protocolos que usam TLS.\nCom esta opção habilitada, o VexeoSoporte ignorará a verificação e prosseguirá em caso de falha."),
        ("Disable UDP", "Desabilitar UDP"),
        ("disable-udp-tip", "Controla se deve usar somente TCP.\nCom esta opção habilitada, o VexeoSoporte não usará mais UDP 21116, TCP 21116 será usado no lugar."),
        ("server-oss-not-support-tip", "NOTA: O servidor VexeoSoporte OSS não inclui este recurso."),
