...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "A ligar à rede do VexeoSoporte..."),
        ...
        ("install_tip", "Devido ao UAC, o VexeoSoporte não funciona correctamente em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o VexeoSoporte no sistema."),
        ("Click to upgrade", "Clique para atualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar o seu Ambiente de Trabalho remotamente, é preciso conceder ao VexeoSoporte permissões de \"Acessibilidade\"."),
        ("config_screen", "Para aceder ao seu Ambiente de Trabalho remotamente, é preciso conceder ao VexeoSoporte permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle o seu dispositivo Android via rato ou toque, você precisa permitir que o VexeoSoporte use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], ACTIVE o serviço [VexeoSoporte Input]."),
        ...
        ("Language", "Linguagem"),
        ("Keep RustDesk background service", "Manter o serviço VexeoSoporte em funcionamento"),
        ("Ignore Battery Optimizations", "Ignorar optimizações de Bateria"),
        ("android_open_battery_optimizations_tip", "Se pretender desativar esta funcionalidade, aceda à próxima página de definições da aplicação VexeoSoporte, encontre e abra [Bateria], e desmarque [Sem restrições]"),
        ...
        ("Show RustDesk", "Mostrar VexeoSoporte"),
        ("This PC", "Este PC"),
        ("or", "ou"),
        ("Elevate", "Elevar"),
        ...
        ("config_input", "Para controlar o ambiente de trabalho remoto com o teclado, é necessário conceder ao VexeoSoporte as permissões de \"Monitorização de Entrada\"."),
        ("config_microphone", "Para falar à distância, é necessário conceder ao VexeoSoporte as permissões de \"Gravar Áudio\"."),
        ...
        ("still_click_uac_tip", "Continua a exigir que o utilizador remoto clique em OK na janela do UAC do VexeoSoporte em execução."),
        ...
        ("verify_rustdesk_password_tip", "Verificar palavra-passe do VexeoSoporte"),
        ...
        ("scam_text1", "Se estiver ao telefone com alguém que NÃO conhece NEM em quem confia e que lhe pediu para usar o VexeoSoporte e iniciar o serviço, não prossiga e desligue imediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualize o VexeoSoporte Server Pro para a versão {} ou mais recente!"),
        ...
        ("selinux_tip", "O SELinux está ativado no seu dispositivo, o que poderá impedir o VexeoSoporte de funcionar corretamente como lado controlado."),
        ...
        ("powered_by_me", "Disponibilizado pelo VexeoSoporte"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir a ligação apenas se a janela do VexeoSoporte estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço em segundo plano do VexeoSoporte"),
        ...
        ("About RustDesk", "Sobre o VexeoSoporte"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente VexeoSoporte para a versão {} ou mais recente no lado remoto!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Por predefinição, o VexeoSoporte verifica o certificado do servidor para os protocolos que usam TLS.\nCom esta opção ativada, o VexeoSoporte recorrerá a ignorar a etapa de verificação e prosseguir em caso de falha de verificação."),
        ("Disable UDP", "Desativar UDP"),
        ("disable-udp-tip", "Controla se deve ser usado apenas TCP.\nQuando esta opção está ativada, o VexeoSoporte deixa de usar a UDP 21116, sendo usada a TCP 21116 em vez dela."),
        ("server-oss-not-support-tip", "NOTA: o VexeoSoporte server OSS não inclui esta funcionalidade."),
