...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till VexeoSoporte..."),
        ...
        ("install_tip", "På grund av UAC, kan inte VexeoSoporte fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera VexeoSoporte på systemet."),
        ("Click to upgrade", "Klicka för att nedgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att kontrollera din dator på distans måste du ge VexeoSoporte \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge VexeoSoporte \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [VexeoSoporte Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep RustDesk background service", "Behåll VexeoSoporte i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa VexeoSoporte programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ...
        ("Show RustDesk", "Visa VexeoSoporte"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
        ("Elevate", "Höj upp"),
        ("Zoom cursor", "Zoom"),
        ...
        ("config_input", "För att kunna styra fjärrskrivbordet med tangentbordet måste du ge VexeoSoporte behörigheten \"Övervaka inmatning\"."),
        ("config_microphone", "För att kunna tala på distans måste du ge VexeoSoporte behörigheten \"Spela in ljud\"."),
        ...
        ("still_click_uac_tip", "Kräver fortfarande att fjärranvändaren klickar på OK i UAC-fönstret för VexeoSoporte."),
        ...
        ("verify_rustdesk_password_tip", "Verifiera VexeoSoporte-lösenord"),
        ...
        ("scam_text1", "Om du talar i telefon med någon du INTE känner OCH litar på, som har bett dig använda VexeoSoporte och starta tjänsten, fortsätt inte och lägg på omedelbart."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Uppgradera VexeoSoporte Server Pro till version {} eller senare!"),
        ...
        ("selinux_tip", "SELinux är aktiverat på din enhet, vilket kan hindra VexeoSoporte från att fungera korrekt som kontrollerad sida."),
        ("Change view", "Byt vy"),
        ...
        ("powered_by_me", "Drivs av VexeoSoporte"),
        ...
        ("allow-only-conn-window-open-tip", "Tillåt endast anslutning om VexeoSoporte-fönstret är öppet"),
        ...
        ("floating_window_tip", "Det hjälper till att hålla VexeoSoporte-bakgrundstjänsten igång"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Uppgradera VexeoSoporte-klienten till version {} eller senare på fjärrsidan!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifierar VexeoSoporte serverns certifikat för protokoll som använder TLS.\nMed detta alternativ aktiverat hoppar VexeoSoporte över verifieringssteget och fortsätter om verifieringen misslyckas."),
        ("Disable UDP", "Inaktivera UDP"),
        ("disable-udp-tip", "Styr om endast TCP ska användas.\nNär detta alternativ är aktiverat använder VexeoSoporte inte längre UDP 21116, utan TCP 21116 används i stället."),
        ("server-oss-not-support-tip", "OBS: VexeoSoporte server OSS inkluderar inte denna funktion."),
