...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip2", "कृपया सिस्टम सेटिंग में VexeoSoporte खोजें और इसे चालू करें।"),
        ...
        ("Language", "भाषा"),
        ("Keep RustDesk background service", "VexeoSoporte बैकग्राउंड सेवा चालू रखें"),
        ...
        ("Show RustDesk", "VexeoSoporte दिखाएं"),
        ("This PC", "यह PC"),
        ("or", "या"),
        ...
        ("verify_rustdesk_password_tip", "VexeoSoporte पासवर्ड सत्यापित करें"),
        ...
        ("scam_text1", "यदि आप किसी ऐसे व्यक्ति से बात कर रहे हैं जिसे आप नहीं जानते और जिसने आपसे VexeoSoporte उपयोग करने को कहा है, तो तुरंत डिस्कनेक्ट कर दें।"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "VexeoSoporte सर्वर प्रो को संस्करण {} में अपग्रेड करें"),
        ...
        ("allow-only-conn-window-open-tip", "केवल तभी कनेक्शन की अनुमति दें जब VexeoSoporte विंडो खुली हो"),
        ...
        ("floating_window_tip", "बैकग्राउंड में रहने के दौरान VexeoSoporte को दिखाएं"),
        ...
        ("About RustDesk", "VexeoSoporte के बारे में"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "रिमोट VexeoSoporte क्लाइंट को संस्करण {} में अपग्रेड करें"),
