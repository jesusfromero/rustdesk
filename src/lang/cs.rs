...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Připojování k VexeoSoporte síti..."),
        ...
        ("install_tip", "Kvůli řízení oprávnění v systému (UAC), VexeoSoporte v některých případech na protistraně nefunguje správně. Abyste se UAC vyhnuli, klikněte na níže uvedené tlačítko a nainstalujte tak VexeoSoporte do systému."),
        ("Click to upgrade", "Aktualizovat"),
        ("Configure", "Nastavit"),
        ("config_acc", "Aby bylo možné na dálku ovládat vaši plochu, je třeba aplikaci VexeoSoporte udělit oprávnění pro \"Zpřístupnění pro hendikepované\"."),
        ("config_screen", "Aby bylo možné přistupovat k vaší ploše na dálku, je třeba aplikaci VexeoSoporte udělit oprávnění pro \"Nahrávání obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby vzdálené zařízení mohlo ovládat vaše Android zařízení prostřednictví myši či dotyků, je třeba povolit, aby VexeoSoporte mohlo používat službu „Zpřístupnění hendikepovaným“."),
        ("android_input_permission_tip2", "Přejděte na následující stránku nastavení systému, najděte a přejděte do [Nainstalované služby] a zapněte službu [VexeoSoporte vstup]."),
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep RustDesk background service", "Zachovat službu VexeoSoporte na pozadí"),
        ("Ignore Battery Optimizations", "Ignorovat optimalizaci baterie"),
        ("android_open_battery_optimizations_tip", "Pokud chcete tuto funkci zakázat, přejděte na další stránku nastavení aplikace VexeoSoporte, najděte a zadejte [Baterie], zrušte zaškrtnutí [Neomezeno]."),
        ...
        ("Show RustDesk", "Zobrazit VexeoSoporte"),
        ...
        ("config_input", "Chcete-li ovládat vzdálenou plochu pomocí klávesnice, musíte udělit oprávnění VexeoSoporte \"Sledování vstupu\"."),
        ("config_microphone", "Abyste mohli mluvit na dálku, musíte udělit oprávnění VexeoSoporte \"Nahrávat zvuk\"."),
        ...
        ("still_click_uac_tip", "Stále vyžaduje, aby vzdálený uživatel kliknul na OK v okně UAC spuštěného VexeoSoporteu."),
        ...
        ("verify_rustdesk_password_tip", "Ověření hesla VexeoSoporte"),
        ...
        ("scam_text1", "Pokud telefonujete s někým, koho NEZNÁTE a komu NEDŮVĚŘUJETE a kdo vás požádal o použití služby VexeoSoporte a její spuštění, nepokračujte v hovoru a okamžitě zavěste."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Aktualizujte prosím VexeoSoporte Server Pro na verzi {} nebo novější!"),
        ...
        ("selinux_tip", "Na vašem zařízení je povolen SELinux, což může bránit správnému běhu VexeoSoporteu jako řízené strany."),
        ...
        ("powered_by_me", "Poháněno společností VexeoSoporte"),
        ...
        ("allow-only-conn-window-open-tip", "Povolit připojení pouze v případě, že je otevřené okno VexeoSoporte"),
        ...
        ("floating_window_tip", "Pomáhá udržovat službu VexeoSoporte na pozadí"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Upgradujte prosím klienta VexeoSoporte na verzi {} nebo novější na vzdálené straně!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Ve výchozím nastavení VexeoSoporte ověřuje certifikát serveru u protokolů používajících TLS.\nKdyž je tato možnost povolena, VexeoSoporte v případě selhání ověření přejde k přeskočení kroku ověření a bude pokračovat."),
        ("Disable UDP", "Zakázat UDP"),
        ("disable-udp-tip", "Určuje, zda se má používat pouze TCP.\nKdyž je tato možnost povolena, VexeoSoporte již nebude používat UDP 21116, místo toho se použije TCP 21116."),
        ("server-oss-not-support-tip", "POZNÁMKA: VexeoSoporte server OSS tuto funkci neobsahuje."),
