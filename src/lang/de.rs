...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Verbinden mit dem VexeoSoporte-Netzwerk …"),
        ...
        ("install_tip", "Aufgrund der Benutzerkontensteuerung (UAC) kann VexeoSoporte in manchen Fällen nicht ordnungsgemäß funktionieren. Um die Benutzerkontensteuerung zu umgehen, klicken Sie bitte auf die Schaltfläche unten und installieren VexeoSoporte auf dem System."),
        ("Click to upgrade", "Zum Upgraden klicken"),
        ("Configure", "Konfigurieren"),
        ("config_acc", "Um Ihren PC aus der Ferne zu steuern, müssen Sie VexeoSoporte Zugriffsrechte erteilen."),
        ("config_screen", "Um aus der Ferne auf Ihren PC zugreifen zu können, müssen Sie VexeoSoporte die Berechtigung \"Bildschirmaufnahme\" erteilen."),
        ...
        ("android_input_permission_tip1", "Damit ein entferntes Gerät Ihr Android-Gerät steuern kann, müssen Sie VexeoSoporte erlauben, den Dienst \"Barrierefreiheit\" zu verwenden."),
        ("android_input_permission_tip2", "Bitte gehen Sie zur nächsten Systemeinstellungsseite, suchen Sie \"Installierte Dienste\" und schalten Sie den Dienst \"VexeoSoporte Input\" ein."),
        ...
        ("Language", "Sprache"),
        ("Keep RustDesk background service", "VexeoSoporte im Hintergrund ausführen"),
        ...
        ("Show RustDesk", "VexeoSoporte anzeigen"),
        ("This PC", "Dieser PC"),
        ("or", "oder"),
        ...
        ("config_input", "Um den entfernten Desktop mit der Tastatur steuern zu können, müssen Sie VexeoSoporte die Berechtigung \"Eingabeüberwachung\" erteilen."),
        ("config_microphone", "Um aus der Ferne sprechen zu können, müssen Sie VexeoSoporte die Berechtigung \"Audio aufzeichnen\" erteilen."),
        ...
        ("still_click_uac_tip", "Der entfernte Benutzer muss immer noch im UAC-Fenster von VexeoSoporte auf \"Ja\" klicken."),
        ...
        ("verify_rustdesk_password_tip", "VexeoSoporte-Passwort bestätigen"),
        ...
        ("scam_text1", "Wenn Sie mit jemandem telefonieren, den Sie NICHT KENNEN, dem Sie NICHT VERTRAUEN und der Sie gebeten hat, VexeoSoporte zu benutzen und den Dienst zu starten, fahren Sie nicht fort und legen Sie sofort auf."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Bitte aktualisieren Sie VexeoSoporte Server Pro auf die Version {} oder neuer!"),
        ...
        ("selinux_tip", "SELinux ist auf Ihrem Gerät aktiviert, was dazu führen kann, dass VexeoSoporte als kontrollierte Seite nicht richtig läuft."),
        ...
        ("powered_by_me", "Unterstützt von VexeoSoporte"),
        ("outgoing_only_desk_tip", "Dies ist eine benutzerdefinierte Ausgabe von VexeoSoporte.\nSie können eine Verbindung zu anderen Geräten herstellen, aber andere Geräte können keine Verbindung zu Ihrem Gerät herstellen."),
        ("preset_password_warning", "Dies ist eine benutzerdefinierte Ausgabe von VexeoSoporte mit einem voreingestellten Passwort. Jeder, der dieses Passwort kennt, kann die volle Kontrolle über Ihr Gerät erlangen. Wenn Sie dies nicht beabsichtigen, deinstallieren Sie diese Software bitte umgehend."),
        ...
        ("allow-only-conn-window-open-tip", "Verbindung nur zulassen, wenn das VexeoSoporte-Fenster geöffnet ist"),
        ...
        ("floating_window_tip", "Es hilft dabei, VexeoSoporte im Hintergrund auszuführen."),
        ...
        ("About RustDesk", "Über VexeoSoporte"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Bitte aktualisieren Sie den VexeoSoporte-Client auf der Remote-Seite auf Version {} oder neuer!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Standardmäßig überprüft VexeoSoporte das Serverzertifikat für Protokolle, die TLS verwenden. Wenn diese Option aktiviert ist, überspringt VexeoSoporte den Überprüfungsschritt und fährt im Falle eines Überprüfungsfehlers fort."),
        ("Disable UDP", "UDP deaktivieren"),
        ("disable-udp-tip", "Legt fest, ob nur TCP verwendet werden soll. Wenn diese Option aktiviert ist, verwendet VexeoSoporte nicht mehr UDP 21116, sondern stattdessen TCP 21116."),
        ("server-oss-not-support-tip", "HINWEIS: VexeoSoporte Server OSS enthält diese Funktion nicht."),
