...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Website", "Sitio web"),
        ("About", "Acerca de"),
        ("Slogan_tip", "Soporte técnico privado de VEXEO Digital Solutions, S.L."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que VexeoSoporte no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar VexeoSoporte a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a VexeoSoporte de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a VexeoSoporte de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que VexeoSoporte use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [VexeoSoporte Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep RustDesk background service", "Dejar VexeoSoporte como Servicio en 2do plano"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a VexeoSoporte permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a VexeoSoporte permisos de \"Grabar Audio\"."),
        ...
        ("verify_rustdesk_password_tip", "Verificar la contraseña de VexeoSoporte"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses VexeoSoporte e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "¡Por favor, actualiza VexeoSoporte Server Pro a la versión {} o superior"),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que VexeoSoporte no se ejecute correctamente como lado controlado."),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de VexeoSoporte de fondo"),
        ...
        ("About RustDesk", "Acerca de VexeoSoporte"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Por favor, actualiza el cliente VexeoSoporte a la versión {} o superior en el lado remoto"),
        ...
        ("allow-insecure-tls-fallback-tip", "De forma predeterminada, VexeoSoporte verifica el certificado de servidor para protocolos que usen TLS.\nCon esta opción habilitada, VexeoSoporte volverá al paso de omisión de verificación y procederá en caso de fallo de verificación."),
        ("Disable UDP", "Inhabilitar UDP"),
        ("disable-udp-tip", "Controla si se usa TCP solamente.\nCuando esta opción está activa, VexeoSoporte no usará más el puerto UDP 21116, en su lugar se usará el TCP 21116."),
        ("server-oss-not-support-tip", "NOTA: El servidor VexeoSoporte OSS no incluye esta característica."),
