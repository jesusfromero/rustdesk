...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "VexeoSoporte ქსელთან დაკავშირება..."),
        ...
        ("install_tip", "ზოგიერთ შემთხვევაში UAC-ის გამო VexeoSoporte შეიძლება არასწორად მუშაობდეს დაშორებულ კვანძზე. UAC-თან დაკავშირებული პრობლემების თავიდან ასაცილებლად დააჭირეთ ქვემოთ მოცემულ ღილაკს სისტემაში VexeoSoporte-ის დასაყენებლად."),
        ("Click to upgrade", "დააჭირეთ განახლებისთვის"),
        ("Configure", "კონფიგურაცია"),
        ("config_acc", "თქვენი სამუშაო მაგიდის დისტანციური მართვისთვის უნდა მიანიჭოთ VexeoSoporte-ს \"წვდომის\" უფლებები"),
        ("config_screen", "სამუშაო მაგიდაზე დისტანციური წვდომისთვის უნდა მიანიჭოთ VexeoSoporte-ს \"ეკრანის ანაბეჭდის\" უფლებები"),
        ...
        ("android_input_permission_tip1", "იმისთვის, რომ დაშორებულმა მოწყობილობამ შეძლოს თქვენი Android-მოწყობილობის მართვა თაგუნათი ან შეხებით, საჭიროა VexeoSoporte-ისთვის \"სპეციალური შესაძლებლობების\" სერვისის გამოყენების უფლების მინიჭება."),
        ("android_input_permission_tip2", "გადადით სისტემის პარამეტრების შესაბამის გვერდზე, იპოვეთ და შედით \"დაინსტალირებულ სერვისებში\", ჩართეთ \"VexeoSoporte Input\" სერვისი."),
        ...
        ("Language", "ენა"),
        ("Keep RustDesk background service", "VexeoSoporte-ის ფონური სერვისის შენარჩუნება"),
        ...
        ("Show RustDesk", "VexeoSoporte-ის ჩვენება"),
        ...
        ("config_input", "დისტანციური სამუშაო მაგიდის კლავიატურით სამართავად, საჭიროა VexeoSoporte-ისთვის \"შეყვანის მონიტორინგის\" უფლების მინიჭება."),
        ("config_microphone", "დისტანციურ მხარესთან სასაუბროდ, საჭიროა VexeoSoporte-ისთვის \"აუდიოს ჩაწერის\" უფლების მინიჭება."),
        ...
        ("still_click_uac_tip", "კვლავ საჭიროა, რომ დისტანციურმა მომხმარებელმა დააჭიროს \"OK\"-ს UAC ფანჯარაში VexeoSoporte-ის გაშვებისას."),
        ...
        ("verify_rustdesk_password_tip", "დაადასტურეთ VexeoSoporte-ის პაროლი"),
        ...
        ("scam_text1", "თუ ტელეფონით ესაუბრებით ვინმეს, ვისაც არ იცნობთ და არ ენდობით, და ის გთხოვთ გამოიყენოთ VexeoSoporte და გაუშვათ მისი სერვისი, არ გააგრძელოთ და დაუყოვნებლივ შეწყვიტეთ საუბარი."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "განაახლეთ VexeoSoporte Server Pro ვერსიამდე {} ან უფრო ახალი!"),
        ...
        ("selinux_tip", "თქვენს მოწყობილობაზე ჩართულია SELinux, რამაც შეიძლება ხელი შეუშალოს VexeoSoporte-ის სწორ მუშაობას მართულ მხარეზე."),
        ("Change view", "ხედი"),
        ...
        ("powered_by_me", "VexeoSoporte-ზე დაფუძნებული"),
        ...
        ("allow-only-conn-window-open-tip", "დაშვება მხოლოდ მაშინ, როცა VexeoSoporte-ის ფანჯარა გახსნილია"),
        ...
        ("floating_window_tip", "ეხმარება VexeoSoporte-ის ფონური სერვისის შენარჩუნებას"),
        ...
        ("About RustDesk", "VexeoSoporte-ის შესახებ"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "განაახლეთ VexeoSoporte კლიენტი ვერსიამდე {} ან უფრო ახალი დისტანციურ მხარეზე!"),
        ...
        ("allow-insecure-tls-fallback-tip", "ნაგულისხმევად VexeoSoporte ამოწმებს სერვერის სერტიფიკატს TLS-ის გამოყენებისას პროტოკოლებისთვის.\nამ პარამეტრის ჩართვისას VexeoSoporte გადავა შემოწმების ეტაპის გამოტოვებაზე და გააგრძელებს მუშაობას შემოწმების წარუმატებლობის შემთხვევაში."),
        ("Disable UDP", "UDP-ის გამორთვა"),
        ("disable-udp-tip", "აკონტროლებს, გამოვიყენოთ თუ არა მხოლოდ TCP.\nამ პარამეტრის ჩართვისას VexeoSoporte აღარ გამოიყენებს UDP 21116-ს, სანაცვლოდ გამოყენებული იქნება TCP 21116."),
        ("server-oss-not-support-tip", "შენიშვნა: VexeoSoporte server OSS არ მოიცავს ამ ფუნქციას."),
