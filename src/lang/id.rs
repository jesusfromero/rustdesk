...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke VexeoSoporte..."),
        ...
        ("install_tip", "Karena UAC, VexeoSoporte tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal VexeoSoporte ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Agar bisa mengontrol Desktopmu dari jarak jauh, Kamu harus memberikan izin \"Aksesibilitas\" untuk VexeoSoporte."),
        ("config_screen", "Agar bisa mengakses Desktopmu dari jarak jauh, kamu harus memberikan izin \"Perekaman Layar\" untuk VexeoSoporte."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android melalui mouse atau sentuhan, Kamu harus memberikan izin/permission kd VexeoSoporte untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input VexeoSoporte]."),
        ...
        ("Language", "Bahasa"),
        ("Keep RustDesk background service", "Pertahankan VexeoSoporte berjalan pada service background"),
        ...
        ("Show RustDesk", "Tampilkan VexeoSoporte"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ("Elevate", "Elevasi"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada VexeoSoporte"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada VexeoSoporte"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC VexeoSoporte yang sedang berjalan"),
        ...
        ("verify_rustdesk_password_tip", "Verifikasi Kata Sandi VexeoSoporte"),
        ...
        ("scam_text1", "Jika anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan VexeoSoporte, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Silahkan perbarui VexeoSoporte Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah VexeoSoporte berfungsi dengan baik sebagai sisi yang dikontrol."),
        ...
        ("powered_by_me", "Didukung oleh VexeoSoporte"),
        ...
        ("allow-only-conn-window-open-tip", "Koneksi hanya diperbolehkan jika jendela VexeoSoporte sedang terbuka."),
        ...
        ("floating_window_tip", "Untuk menjaga layanan/service VexeoSoporte agar tetap aktif"),
        ...
        ("About RustDesk", "Tentang VexeoSoporte"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Silahkan perbarui aplikasi VexeoSoporte ke versi {} atau yang lebih baru pada komputer yang akan terhubung!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Secara default, VexeoSoporte memverifikasi sertifikat server untuk protokol yang menggunakan TLS.\nDengan opsi ini diaktifkan, VexeoSoporte akan kembali melewati langkah verifikasi dan melanjutkan jika verifikasi gagal."),
        ("Disable UDP", "Nonaktifkan UDP"),
        ("disable-udp-tip", "Mengontrol apakah hanya menggunakan TCP.\nSaat opsi ini diaktifkan, VexeoSoporte tidak akan menggunakan UDP 21116 lagi, TCP 21116 akan digunakan sebagai gantinya."),
        ("server-oss-not-support-tip", "CATATAN: VexeoSoporte server OSS tidak menyertakan fitur ini."),
