...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "VexeoSoporte sarera konektatzen..."),
        ...
        ("install_tip", "Erabiltzaile Kontuen Kontrolarengatik, VexeoSoporte ezin du ondo funtzionatu urruneko mahaigainean. EKK saihesteko, mesedez, egin klik azpiko botoian VexeoSoporte sistema mailan instalatzeko."),
        ("Click to upgrade", "Egin klik bertsio-berritzeko"),
        ("Configure", "Konfiguratu"),
        ("config_acc", "Zure mahaigaina urrunetik kontrolatzeko, VexeoSoporte-i \"Irisgarritasuna\" baimenak eman behar dituzu."),
        ("config_screen", "Zure mahaigaina kanpotik kontrolatzeko, VexeoSoporte-i \"Pantaila grabatu\" baimena eman behar duzu."),
        ...
        ("android_input_permission_tip1", "Urruneko gailu batek zure Android gailua saguaren edo ukipenaren bidez kontrolatzeko, VexeoSoporte \"Irisgarritasuna\" zerbitzua erabiltzeko baimena eman behar diozu."),
        ("android_input_permission_tip2", "Joan hurrengo irekiko den sistemaren konfigurazio orrira, bilatu eta sartu [Instalatutako zerbitzuak], aktibatu [VexeoSoporte Input] zerbitzua."),
        ...
        ("Turned off", "Itzalita"),
        ("Language", "Hizkuntza"),
        ("Keep RustDesk background service", "Mantendu VexeoSoporte atzeko planoko zerbitzu bezala"),
        ("Ignore Battery Optimizations", "Ezikusi bateria optimizazioak"),
        ("android_open_battery_optimizations_tip", "Ezaugarri hau desgaitu nahi baduzu, joan zaitez VexeoSoporte aplikazioaren ezarpen orrira, bilatu eta saltu [Bateria] orrira eta kendu [Mugarik gabe]"),
        ...
        ("Show RustDesk", "Erakutsi VexeoSoporte"),
        ("This PC", "PC hau"),
        ("or", "edo"),
        ("Elevate", "Igo maila"),
        ...
        ("config_input", "Urruneko mahaigaina teklatuaren bidez kontrolatzeko, VexeoSoporte-i \"Sarrera monitorizazioa\" baimena eman behar diozu."),
        ("config_microphone", "Urrunetik hitz egin ahal izateko, VexeoSoportei-i \"Grabatu audioa\" baimena eman behar diozu."),
        ...
        ("still_click_uac_tip", "Oraindik beharrezkoa da urruneko erabiltzaileak Ondo botoiari klik egitea exekutatzen ari den VexeoSoporte UAC leihoan"),
        ...
        ("verify_rustdesk_password_tip", "Berretsi VexeoSoporte pasahitza"),
        ...
        ("scam_text1", "Ezagutzen eta fidatzen EZ duzun norbaitekin telefonoz bazaude eta VexeoSoporte erabiltzeko eta zerbitzua abiarazteko eskatu badizute, ez ezazu egin eta eskegi berehala."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Mesedez, bertsio-berritu VexeoSoporte Server Pro {} bertsiora edo berriago batera!"),
        ...
        ("selinux_tip", "SELinux zure gailuan gaituta dago. Honek VexeoSoporte kontrolatutako alde gisa dagoenean behar bezala ez exekutatzea ekarri dezake."),
        ...
        ("powered_by_me", "VexeoSoporte-ek egina"),
        ...
        ("allow-only-conn-window-open-tip", "Baimendu konexioa VexeoSoporte leihoa irekita badago"),
        ...
        ("floating_window_tip", "VexeoSoporte atzeko planoko zerbitzua mantentzen laguntzen du"),
        ...
        ("About RustDesk", "VexeoSoporte-i buruz"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Mesedez, eguneratu VexeoSoporte bezeroa {} bertsiora edo berriagoa urruneko aldean!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Modu lehenetsian, VexeoSoporte-ek zerbitzariaren ziurtagiria egiaztatzen du TLS erabiltzen duten protokoloetarako.\nAukera hau gaituta dagoela, VexeoSoporte-ek egiaztapen-urratsa saltatzera joko du eta aurrera egingo du egiaztapenak huts eginez gero."),
        ("Disable UDP", "Desgaitu UDP"),
        ("disable-udp-tip", "TCP soilik erabiliko den kontrolatzen du.\nAukera hau gaituta dagoenean, VexeoSoporte-ek ez du gehiago UDP 21116 erabiliko; horren ordez, TCP 21116 erabiliko da."),
        ("server-oss-not-support-tip", "OHARRA: VexeoSoporte zerbitzariaren OSS bertsioak ez du ezaugarri hau barne hartzen."),
