...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ідзе падключэнне да сеткі VexeoSoporte..."),
        ...
        ("install_tip", "У некаторых выпадках з-за UAC, VexeoSoporte можа працаваць на баку абанента неадпаведным чынам. Каб пазбегнуць магчымых праблем з UAC, націсніце кнопку ніжэй для ўсталявання VexeoSoporte у сістэме."),
        ("Click to upgrade", "Абнавіць"),
        ("Configure", "Наладзіць"),
        ("config_acc", "Каб аддаленна кіраваць сваім працоўным сталом, вам трэба дазволіць VexeoSoporte правы \"доступу\""),
        ("config_screen", "Для аддаленага доступу да працоўнага стала вам трэба даць VexeoSoporte правы \"здымку экрана\"."),
        ...
        ("android_input_permission_tip1", "Каб аддаленая прылада магла кіраваць вашай Android-прыладай з дапамогай мышы або націсканняў, трэба дазволіць VexeoSoporte выкарыстоўваць службу \"Спецыяльныя магчымасці\"."),
        ("android_input_permission_tip2", "Зайдзіце на адпаведную старонку сістэмных налад, знайдзіце і перайдзіце ва \"Усталяваныя службы\", уключыце службу \"VexeoSoporte Input\"."),
        ...
        ("Language", "Мова"),
        ("Keep RustDesk background service", "Захаваць фонавую службу VexeoSoporte"),
        ...
        ("Show RustDesk", "Паказаць VexeoSoporte"),
        ...
        ("config_input", "Каб кіраваць аддаленым працоўным сталом праз клавіятуру, трэба дазволіць VexeoSoporte \"Маніторынг уводу\"."),
        ("config_microphone", "Каб размаўляць з абанентам, трэба дазволіць VexeoSoporte запіс аўдыя."),
        ...
        ("still_click_uac_tip", "Дагэтуль патрэбна, каб абанент націснуў \"OK\" ў акне UAC пры запуску VexeoSoporte."),
        ...
        ("verify_rustdesk_password_tip", "Пацвердзіць пароль VexeoSoporte"),
        ...
        ("scam_text1", "Калі вы размаўляеце па тэлефоне з кімсьці НЕЗНАЁМЫМ і каму вы НЕ ДАВЕРАЕЦЕ, і гэта асоба просіць вас выкарыстаць VexeoSoporte і запусціць яго службу, не працягвайце і неадкладна скончыце размову."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Абнавіце VexeoSoporte Server Pro да версіі {} або навейшай!"),
        ...
        ("selinux_tip", "На вашай прыладзе ўключаны SELinux, што можа ствараць перашкоды ў працы VexeoSoporte на баку абанента."),
        ("Change view", "Рэжым"),
        ...
        ("powered_by_me", "Заснавана на VexeoSoporte"),
        ...
        ("allow-only-conn-window-open-tip", "Дазволіць падключэнне толькі пры адкрытым акне VexeoSoporte"),
        ...
        ("floating_window_tip", "Дапамагае падтрымліваць фонавую службу VexeoSoporte"),
        ...
        ("About RustDesk", "Пра VexeoSoporte"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Абнавіце кліент VexeoSoporte да версіі {} або навейшай на баку абанента!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Стандартна VexeoSoporte правярае сертыфікат сервера на наяўнасць пратаколаў, якія выкарыстоўваюць TLS.\nКалі гэта функцыя ўключана, VexeoSoporte прапусціць дадзены этап і працягне працу ў выпадку няўдалай праверкі."),
        ("Disable UDP", "Выключыць UDP"),
        ("disable-udp-tip", "Вызначае, ці варта выкарыстоўваць толькі TCP.\nКалі ўключана, VexeoSoporte не будзе выкарыстоўваць UDP 21116, замест чаго будзе выкарыстоўвацца TCP 21116."),
        ("server-oss-not-support-tip", "ЗАЎВАГА! у OSS-серверы VexeoSoporte гэта функцыя адсутнічае."),
