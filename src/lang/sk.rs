...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Pripájam sa na VexeoSoporte server..."),
        ...
        ("install_tip", "V niektorých prípadoch VexeoSoporte nefunguje správne z dôvodu riadenia užívateľských oprávnení (UAC). Vyhnete sa tomu kliknutím na nižšie zobrazene tlačítko a nainštalovaním RuskDesk do systému."),
        ("Click to upgrade", "Kliknutím nainštalujete aktualizáciu"),
        ("Configure", "Nastaviť"),
        ("config_acc", "Aby bolo možné na diaľku ovládať vašu plochu, je potrebné aplikácii VexeoSoporte udeliť práva \"Dostupnosť\"."),
        ("config_screen", "Aby bolo možné na diaľku sledovať vašu obrazovku, je potrebné aplikácii VexeoSoporte udeliť práva \"Zachytávanie obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby bolo možné na diaľku ovládať vašu plochu pomocou myši alebo dotykov, je potrebné aplikácii VexeoSoporte udeliť práva \"Dostupnosť\"."),
        ("android_input_permission_tip2", "Prejdite na stránku nastavení systému, nájdite a vstúpte do [Stiahnuté služby], zapnite [VexeoSoporte Input] službu."),
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep RustDesk background service", "Ponechať službu VexeoSoporte na pozadí"),
        ("Ignore Battery Optimizations", "Ignorovať optimalizácie batérie"),
        ("android_open_battery_optimizations_tip", "Ak chcete túto funkciu vypnúť, prejdite na ďalšiu stránku nastavení VexeoSoporteu, vyhľadajte a zadajte položku [Batéria], zrušte začiarknutie položky [Neobmedzené]."),
        ...
        ("Show RustDesk", "Zobraziť VexeoSoporte"),
        ...
        ("config_input", "Ak chcete ovládať vzdialenú plochu pomocou klávesnice, musíte udeliť oprávnenie VexeoSoporte \"Sledovanie vstupu\"."),
        ("config_microphone", "Ak chcete hovoriť na diaľku, musíte VexeoSoporteu udeliť povolenie \"Nahrávať zvuk\"."),
        ...
        ("still_click_uac_tip", "Stále sa vyžaduje, aby vzdialený používateľ klikol na tlačidlo OK v okne UAC spusteného programu VexeoSoporte."),
        ...
        ("verify_rustdesk_password_tip", "Overenie hesla VexeoSoporte"),
        ...
        ("scam_text1", "Ak telefonujete s niekým, koho nepoznáte a komu nedôverujete a kto vás požiadal o použitie a spustenie aplikácie VexeoSoporte, nepokračujte v hovore a okamžite zaveste."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Aktualizujte VexeoSoporte Server Pro na verziu {} alebo novšiu!"),
        ...
        ("selinux_tip", "Na vašom zariadení je povolený SELinux, čo môže brániť správnemu spusteniu VexeoSoporteu ako spravovanej strany."),
        ...
        ("powered_by_me", "Poháňané aplikáciou VexeoSoporte"),
        ...
        ("allow-only-conn-window-open-tip", "Povoliť pripojenie iba vtedy, ak je otvorené okno aplikácie VexeoSoporte"),
        ...
        ("floating_window_tip", "Pomáha udržiavať službu VexeoSoporte na pozadí"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Aktualizujte klienta VexeoSoporte na verziu {} alebo novšiu na vzdialenej strane!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Štandardne VexeoSoporte overuje certifikát servera pre protokoly používajúce TLS.\nS touto možnosťou VexeoSoporte v prípade zlyhania overenia preskočí krok overovania a bude pokračovať."),
        ("Disable UDP", "Vypnúť UDP"),
        ("disable-udp-tip", "Určuje, či sa má používať iba TCP.\nKeď je táto možnosť povolená, VexeoSoporte už nebude používať UDP 21116, namiesto neho sa použije TCP 21116."),
        ("server-oss-not-support-tip", "POZNÁMKA: VexeoSoporte server OSS túto funkciu neobsahuje."),
