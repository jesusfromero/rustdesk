...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "În curs de conectare la rețeaua VexeoSoporte..."),
        ...
        ("install_tip", "Din cauza restricțiilor CCU, este posibil ca VexeoSoporte să nu funcționeze corespunzător. Pentru a evita acest lucru, dă clic pe butonul de mai jos pentru a instala VexeoSoporte."),
        ("Click to upgrade", "Dă clic pentru a face upgrade"),
        ("Configure", "Configurează"),
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți VexeoSoporte acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți VexeoSoporte acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți VexeoSoporte să utilizeze serviciul „Accesibilitate\"."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, deschide [Aplicații instalate] și pornește serviciul [VexeoSoporte Input]."),
        ...
        ("Turned off", "Închis"),
        ("Language", "Limbă"),
        ("Keep RustDesk background service", "Rulează serviciul VexeoSoporte în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației VexeoSoporte, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ...
        ("Show RustDesk", "Afișează VexeoSoporte"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
        ...
        ("config_input", "Pentru a controla desktopul la distanță folosind tastatura, trebuie să acorzi VexeoSoporte permisiunea Monitorizare intrare"),
        ("config_microphone", "Pentru a desfășura un apel vocal, este nevoie să acorzi VexeoSoporte permisiunea Înregistrare audio."),
        ...
        ("still_click_uac_tip", "Este necesar ca utilizatorul la distanță să confirme în fereastra CCU din VexeoSoporte care rulează."),
        ...
        ("verify_rustdesk_password_tip", "Verifică parola VexeoSoporte"),
        ...
        ("scam_text1", "Escrocii se pot da drept angajați ai asistenței tehnice și îți pot solicita să instalezi sau să rulezi VexeoSoporte pentru a-ți accesa dispozitivul."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Versiunea serverului VexeoSoporte Pro este mai mică decât {}. Te rugăm să o actualizezi."),
        ...
        ("input_source_2_tip", "Sursă de intrare 2 — folosește driver-ul VexeoSoporte pentru simulare la nivel de kernel"),
        ...
        ("powered_by_me", "Realizat cu VexeoSoporte"),
        ...
        ("ab_web_console_tip", "Gestionează agenda prin consola web VexeoSoporte Pro."),
        ...
        ("enable-bot-desc", "Configurează un bot Telegram pentru notificări VexeoSoporte. Introdu token-ul botului și ID-ul chat-ului."),
        ...
        ("About RustDesk", "Despre VexeoSoporte"),
        ...
        ("web_id_input_tip", "Introdu ID-ul VexeoSoporte al dispozitivului la care vrei să te conectezi"),
        ("Download", "Descarcă"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Versiunea clientului VexeoSoporte de la distanță este mai mică decât {}. Te rugăm să o actualizezi pentru o compatibilitate completă."),
        ...
        ("server-oss-not-support-tip", "Serverul open-source nu suportă această funcție. Folosește VexeoSoporte Pro pentru funcționalitate completă."),
