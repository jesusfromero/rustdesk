...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter tilkobling til VexeoSoporte-nettverket..."),
        ...
        ("install_tip", "På grunn av UAC kan VexeoSoporte ikke fungere korrekt i enkelte tillfeller på fjernskrivebordet. For å unngå UAC klikker du på knappen nedenfor for å installere VexeoSoporte på systemet"),
        ("Click to upgrade", "Klikk for å oppgradere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For å kontrollere ditt skrivebord med fjernstyring må du gi VexeoSoporte \"Access \" Rettigheter."),
        ("config_screen", "For å kunne få adgang til ditt skrivebord med fjernstyring, må du gi VexeoSoporte \"skjerstøtte \" tillatelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhet kan kontrollere din Android-enhet via mus eller berøring, må du gi VexeoSoporte mulighet til å bruke tjenesten \"tilgjengelighet \"."),
        ("android_input_permission_tip2", "Gå til den neste systeminnstillingssiden, søk og tast inn [installerte tjenester], aktiver [VexeoSoporte Input] tjenesten."),
        ...
        ("android_open_battery_optimizations_tip", "Hvis du vil deaktivere denne funksjonen, gå til neste innstillingsside for VexeoSoporte-applikasjonen, finn og åpne [Batteri], og fjern haken ved [Ubegrenset]."),
        ...
        ("config_input", "For å kunne styre fjernskrivebordet med tastatur må du gi VexeoSoporte tillatelsen \"Inndataovervåking\"."),
        ("config_microphone", "For å kunne snakke eksternt må du gi VexeoSoporte tillatelsen \"Ta opp lyd\"."),
        ...
        ("still_click_uac_tip", "Krever fortsatt at fjernbrukeren klikker OK på UAC-vinduet til den kjørende VexeoSoporte."),
        ...
        ("verify_rustdesk_password_tip", "Verifiser VexeoSoporte-passord"),
        ...
        ("scam_text1", "Hvis du snakker i telefonen med noen du IKKE kjenner OG STOLER PÅ, som har bedt deg om å bruke VexeoSoporte og starte tjenesten, ikke fortsett og legg på umiddelbart."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Vennligst oppgrader VexeoSoporte Server Pro til versjon {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktivert på enheten din, noe som kan hindre VexeoSoporte i å fungere som det skal på den kontrollerte siden."),
        ...
        ("powered_by_me", "Drevet av VexeoSoporte"),
        ...
        ("allow-only-conn-window-open-tip", "Tillat kun tilkobling hvis VexeoSoporte-vinduet er åpent"),
        ...
        ("floating_window_tip", "Det bidrar til å holde VexeoSoporte-bakgrunnstjenesten i gang"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Vennligst oppgrader VexeoSoporte-klienten til versjon {} eller nyere på fjernsiden!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifiserer VexeoSoporte serversertifikatet for protokoller som bruker TLS.\nMed dette alternativet aktivert vil VexeoSoporte falle tilbake til å hoppe over verifiseringstrinnet og fortsette ved verifiseringsfeil."),
        ("Disable UDP", "Deaktiver UDP"),
        ("disable-udp-tip", "Styrer om kun TCP skal brukes.\nNår dette alternativet er aktivert, vil VexeoSoporte ikke lenger bruke UDP 21116, TCP 21116 brukes i stedet."),
        ("server-oss-not-support-tip", "MERK: VexeoSoporte server OSS inkluderer ikke denne funksjonen."),
