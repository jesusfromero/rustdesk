...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione a sa rete VexeoSoporte..."),
        ...
        ("install_tip", "Pro neghe de su Controllu Contu Utente (UAC), VexeoSoporte diat pòdere non funtzionare comente si tocat comente iscrivania remota.\nPro evitare custu problema, incarca in su butone inoghe in suta pro installare VexeoSoporte a livellu de sistema."),
        ("Click to upgrade", "Atualiza"),
        ("Configure", "Cunfigura"),
        ("config_acc", "Pro controllare s'iscrivania dae foras, depes frunire a VexeoSoporte su permissu 'Atzessibilidade'."),
        ("config_screen", "Pro controllare s'iscrivania dae foras, depes frunire a VexeoSoporte su permissu 'Registratzione ischermu'."),
        ...
        ("android_input_permission_tip1", "Pro chi unu dispositivu remotu potzat controllare unu dispositivu Android pro mèdiu de unu ratu o cun su tocu, depes cunsentire a VexeoSoporte de impreare su servìtziu 'Atzessibilidade'."),
        ("android_input_permission_tip2", "Bae a sa pàgina de sas impostatziones de sistema chi s'at a abèrrere a pustis, busca e intra a [Servìtzios installados], allughe su servìtziu [Intrada VexeoSoporte]."),
        ...
        ("Turned off", "Istuda"),
        ("Language", "Limba"),
        ("Keep RustDesk background service", "Mantene su servìtziu de VexeoSoporte in s'isfundu"),
        ("Ignore Battery Optimizations", "Ignora sas otimizatziones de sa bateria"),
        ("android_open_battery_optimizations_tip", "Si boles disabilitare custa funtzione, bae a sas impostatziones de s'aplicatzione VexeoSoporte, aberi sa setzione 'Bateria' e boga sa seletzione a 'Chene restritziones'."),
        ...
        ("Show RustDesk", "Mustra VexeoSoporte"),
        ("This PC", "Custu PC"),
        ("or", "O"),
        ("Elevate", "Cresche"),
        ...
        ("config_input", "Pro controllare s'elaboradore remotu cun su tecladu bisòngiat a frunire a VexeoSoporte sos permissos de 'Monitoràgiu insertada'."),
        ("config_microphone", "Per pòdere mutire, bisòngiat a frunire su premissu 'Registra àudio' a VexeoSoporte."),
        ...
        ("still_click_uac_tip", "Torra a pedire chi s'utente remotu seletziones 'AB' in sa ventana UAC de s'esecutzione de VexeoSoporte."),
        ...
        ("verify_rustdesk_password_tip", "Cunfirma sa crae de VexeoSoporte"),
        ...
        ("Exit", "Essi dae VexeoSoporte"),
        ("Open", "Aberi VexeoSoporte"),
        ...
        ("scam_text1", "Si ses in su telèfonu cun calicunu chi NON connosches NON FIDADU chi t'at pedidu de impreare VexeoSoporte e de allùghere su servìtziu, non sigas e tanca deretu."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualiza VexeoSoporte Server Pro a sa versione {} o prus noa!"),
        ...
        ("selinux_tip", "In custu dispositivu est abilitadu SELinux, chi diat pòdere su funtzionamentu curretu de VexeoSoporte comente ala controllada."),
        ...
        ("powered_by_me", "Alimentadu dae VexeoSoporte"),
        ...
        ("allow-only-conn-window-open-tip", "Permite sa connessione petzi si sa ventana VexeoSoporte est aberta"),
        ...
        ("floating_window_tip", "Agiudat a mantènnere su servìtziu in s'isfundu de VexeoSoporte"),
        ...
        ("About RustDesk", "Informatziones subra de VexeoSoporte"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualiza su cliente VexeoSoporte remotu a sa versione {} o prus noa!"),
        ...
        ("allow-insecure-tls-fallback-tip", "De manera predefinida, VexeoSoporte averguat su certificadu de su serbidore pro sos protocollos chi impreant TLS.\nCun custa optzione ativada, VexeoSoporte at a brincare s'averguada e at a sighire in casu de faddina de averguada."),
        ("Disable UDP", "Disabìlita UDP"),
        ("disable-udp-tip", "Controllat si impreare petzi su TCP.\nCun custa optzione ativada, VexeoSoporte no at a impreare prus sa UDP 21116, ma at a impreare sa TCP 21116."),
        ("server-oss-not-support-tip", "NOTA: su serbidore OSS de VexeoSoporte non includet custa funtzione."),
