...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään VexeoSoporte verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa VexeoSoporte ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi VexeoSoportein järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava VexeoSoporteille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava VexeoSoporteille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten VexeoSoporte daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota VexeoSoporteille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli VexeoSoporte ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "VexeoSoporte palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa VexeoSoportein asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "VexeoSoporte palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep RustDesk background service", "Pidä VexeoSoportein taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista VexeoSoportein akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("Show RustDesk", "Näytä VexeoSoporte"),
        ...
        ("verify_rustdesk_password_tip", "Vahvista VexeoSoporte salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "VexeoSoporte ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Päivitä VexeoSoporte Server Pro versioon {} jatkaaksesi."),
        ...
        ("About RustDesk", "Tietoa VexeoSoporteistä"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Päivitä etä-VexeoSoporte-asiakasversioon {} yhteensopivuuden takaamiseksi"),
        ...
        ("allow-insecure-tls-fallback-tip", "Oletuksena VexeoSoporte vahvistaa palvelimen varmenteen TLS:ää käyttävissä protokollissa.\nKun tämä asetus on käytössä, VexeoSoporte ohittaa vahvistusvaiheen ja jatkaa toimintaa, jos vahvistus epäonnistuu."),
        ("Disable UDP", "Poista UDP käytöstä"),
        ("disable-udp-tip", "Määrittää, käytetäänkö vain TCP:tä.\nKun tämä asetus on käytössä, VexeoSoporte ei enää käytä UDP-porttia 21116, vaan sen sijaan käytetään TCP-porttia 21116."),
        ("server-oss-not-support-tip", "HUOMAUTUS: VexeoSoporte-palvelimen OSS ei sisällä tätä ominaisuutta."),
