...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Notiek savienojuma izveide ar VexeoSoporte tīklu..."),
        ...
        ("install_tip", "UAC dēļ VexeoSoporte dažos gadījumos nevar pareizi darboties kā attālā puse. Lai izvairītos no UAC, lūdzu, noklikšķiniet uz tālāk esošās pogas, lai instalētu VexeoSoporte sistēmā."),
        ("Click to upgrade", "Jaunināt"),
        ("Configure", "Konfigurēt"),
        ("config_acc", "Lai attālināti vadītu savu darbvirsmu, jums ir jāpiešķir VexeoSoporte \"Pieejamība\" atļaujas."),
        ("config_screen", "Lai attālināti piekļūtu darbvirsmai, jums ir jāpiešķir VexeoSoporte \"Ekrāna tveršana\" atļaujas."),
        ...
        ("android_input_permission_tip1", "Lai attālā ierīce varētu vadīt jūsu Android ierīci, izmantojot peli vai pieskārienu, jums ir jāatļauj VexeoSoporte izmantot servisu \"Pieejamība\"."),
        ("android_input_permission_tip2", "Lūdzu, dodieties uz nākamo sistēmas iestatījumu lapu, atrodiet un atveriet [Instalētie pakalpojumi], ieslēdziet servisu [VexeoSoporte Input]."),
        ...
        ("Turned off", "Izslēgts"),
        ("Language", "Valoda"),
        ("Keep RustDesk background service", "Saglabāt VexeoSoporte fona servisu"),
        ("Ignore Battery Optimizations", "Ignorēt akumulatora optimizāciju"),
        ("android_open_battery_optimizations_tip", "Ja vēlaties atspējot šo funkciju, lūdzu, dodieties uz nākamo VexeoSoporte lietojumprogrammas iestatījumu lapu, atrodiet un atveriet [Akumulators], noņemiet atzīmi no [Neierobežots]"),
        ...
        ("Show RustDesk", "Rādīt VexeoSoporte"),
        ("This PC", "Šis dators"),
        ("or", "vai"),
        ("Elevate", "Pacelt"),
        ...
        ("config_input", "Lai vadītu attālo darbvirsmu ar tastatūru, jums ir jāpiešķir VexeoSoporte \"Ievades uzraudzība\" atļaujas."),
        ("config_microphone", "Lai runātu attālināti, jums ir jāpiešķir VexeoSoporte \"Ierakstīt audio\" atļaujas."),
        ...
        ("still_click_uac_tip", "Joprojām attālajam lietotājam ir jānoklikšķina uz Labi UAC logā, kurā darbojas VexeoSoporte."),
        ...
        ("verify_rustdesk_password_tip", "Pārbaudīt VexeoSoporte paroli"),
        ...
        ("scam_text1", "Ja sarunājaties ar kādu, kuru nepazīstat un kurš ir lūdzis izmantot VexeoSoporte, lai sāktu pakalpojumu, neturpiniet un nekavējoties nolieciet klausuli."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Lūdzu, jauniniet VexeoSoporte Server Pro uz versiju {} vai jaunāku!"),
        ...
        ("selinux_tip", "Jūsu ierīcē ir iespējots SELinux, kas var neļaut VexeoSoporte pareizi darboties kā kontrolētajai pusei."),
        ...
        ("powered_by_me", "Darbojas ar VexeoSoporte"),
        ...
        ("allow-only-conn-window-open-tip", "Atļaut savienojumu tikai tad, ja ir atvērts VexeoSoporte logs"),
        ...
        ("floating_window_tip", "Tas palīdz uzturēt VexeoSoporte fona servisu"),
        ...
        ("About RustDesk", "Par VexeoSoporte"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Lūdzu, jauniniet attālās puses VexeoSoporte klientu uz versiju {} vai jaunāku!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Pēc noklusējuma VexeoSoporte pārbauda servera sertifikātu protokoliem, izmantojot TLS.\nJa šī opcija ir iespējota, VexeoSoporte izlaidīs verifikācijas soli un turpinās darbību verifikācijas kļūmes gadījumā."),
        ("Disable UDP", "Atspējot UDP"),
        ("disable-udp-tip", "Nosaka, vai izmantot tikai TCP.\nKad šī opcija ir iespējota, VexeoSoporte vairs neizmantos UDP 21116, tā vietā tiks izmantots TCP 21116."),
        ("server-oss-not-support-tip", "PIEZĪME. VexeoSoporte servera OSS neietver šo funkciju."),
