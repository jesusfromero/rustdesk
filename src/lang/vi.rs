...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới VexeoSoporte..."),
        ...
        ("install_tip", "Do cơ chế UAC, VexeoSoporte có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt VexeoSoporte vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho VexeoSoporte."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho VexeoSoporte."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [VexeoSoporte Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep RustDesk background service", "Giữ dịch vụ VexeoSoporte chạy nền"),
        ...
        ("Show RustDesk", "Hiện VexeoSoporte"),
        ...
        ("verify_rustdesk_password_tip", "Xác thực mật khẩu VexeoSoporte"),
        ...
        ("scam_text2", "Chỉ sử dụng VexeoSoporte với những người bạn thực sự tin tưởng."),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ VexeoSoporte mở"),
        ...
        ("floating_window_tip", "Giữ VexeoSoporte trên cùng"),
        ...
        ("About RustDesk", "Về VexeoSoporte"),
