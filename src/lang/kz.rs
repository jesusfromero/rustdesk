...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Дайын"),
        ("Established", "Қосылды"),
        ("connecting_status", "VexeoSoporte желісіне қосылуда..."),
        ...
        ("install_tip", "UAC кесірінен, VexeoSoporte кейбірде қашықтағы жақ ретінде дұрыс жұмыс істей алмайды. UAC'пен қиындықты болдырмау үшін, төмендегі батырманы басып VexeoSoporte'ті жүйеге орнатыңыз."),
        ("Click to upgrade", "Жаңғырту үшін басыңыз"),
        ("Configure", "Қалыптау"),
        ("config_acc", "Сіздің Жұмыс үстеліңізді қашықтан басқару үшін, VexeoSoporte'ке \"Қолжетімділік\" рұқсаттарын беруіңіз керек."),
        ("config_screen", "Сіздің Жұмыс үстеліңізге қашықтан қол жеткізу үшін, VexeoSoporte'ке \"Екіренді Жазу\" рұқсаттарын беруіңіз керек."),
        ("Installing ...", "Орнатылу..."),
        ("Install", "Орнату"),
        ...
        ("android_input_permission_tip1", "Қашықтағы құрылғы сіздің Android құрылғыңызды тінтуір немесе түрту арқылы басқару үшін, VexeoSoporte'ке \"Қолжетімділік\" сербесін қолдануға рұқсат беруініз керек."),
        ("android_input_permission_tip2", "Келесі Жүйе Орнатпалары бетіне барып, [Орнатылған Сербестер]'ді тауып кіріңіз, сосын [VexeoSoporte Еңгізу] сербесін іске қосыңыз."),
        ...
        ("Language", "Тіл"),
        ("Keep RustDesk background service", "Артжақтағы VexeoSoporte сербесін сақтап тұру"),
        ("Ignore Battery Optimizations", "Бәтері Оңтайландыруларын Елемеу"),
        ("android_open_battery_optimizations_tip", "Егер де бұл ерекшелікті өшіруді қаласаңыз, келесі VexeoSoporte апылқат орнатпалары бетіне барып, [Бәтері]'ні тауып кіріңіз де [Шектеусіз]'ден құсбелгіні алып тастауды өтінеміз"),
        ...
        ("Show RustDesk", "VexeoSoporte'ті көрсету"),
        ("This PC", "Бұл ДК"),
        ("or", "немесе"),
        ...
        ("config_input", "Қашықтағы жұмыс үстелін пернетақтамен басқару үшін, VexeoSoporte'ке \"Еңгізуді Қадағалау\" рұқсаттарын беруіңіз керек."),
        ("config_microphone", "Қашықтан сөйлесу үшін, VexeoSoporte'ке \"Аудио Жазу\" рұқсаттарын беруіңіз керек."),
        ...
        ("still_click_uac_tip", "Қашықтағы қолданушыдан VexeoSoporte іске қосылған UAC терезесінде OK басуды әлі де талап етеді."),
        ...
        ("verify_rustdesk_password_tip", "VexeoSoporte құпия сөзін тексеру"),
        ...
        ("scam_text1", "Егер сіз танымайтын ЖӘНЕ СЕНБЕЙТІН біреумен телефонмен сөйлесіп жатсаңыз және ол сізден VexeoSoporte қолданып, сербесті іске қосуды сұраса, жалғастырмаңыз да дереу телефонды қойыңыз."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "VexeoSoporte Server Pro'ны {} немесе одан жаңа нұсқаға жаңартуды өтінеміз!"),
        ...
        ("selinux_tip", "Сіздің құрылғыңызда SELinux қосылған, бұл VexeoSoporte'тің басқарылатын жақ ретінде дұрыс жұмыс істеуіне кедергі келтіруі мүмкін."),
        ...
        ("powered_by_me", "VexeoSoporte негізінде"),
        ...
        ("allow-only-conn-window-open-tip", "Тек VexeoSoporte терезесі ашық болғанда ғана қосылымға рұқсат ету"),
        ...
        ("floating_window_tip", "Ол VexeoSoporte артжақ сербесін сақтап тұруға көмектеседі"),
        ...
        ("About RustDesk", "VexeoSoporte туралы"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Қашықтағы жақтағы VexeoSoporte клиентін {} немесе одан жоғары нұсқаға жаңартуды өтінеміз!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Әдепкіде VexeoSoporte TLS қолданатын протоколдар үшін сербер сертификатын тексереді.\nБұл опция қосылғанда, VexeoSoporte тексеру сәтсіз болған жағдайда тексеру қадамын өткізіп жіберуге қайтып, жалғастырады."),
        ("Disable UDP", "UDP-ні өшіру"),
        ("disable-udp-tip", "Тек TCP қолданатынын-қолданбайтынын басқарады.\nБұл опция қосылғанда, VexeoSoporte енді UDP 21116 қолданбайды, оның орнына TCP 21116 қолданылады."),
        ("server-oss-not-support-tip", "ЕСКЕРТПЕ: VexeoSoporte server OSS бұл ерекшелікті қамтымайды."),
