...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Zbog UAC VexeoSoporte ne može raditi pravilno u nekim slučajevima. Da biste prevazišli UAC, kliknite taster ispod da instalirate VexeoSoporte na sistem."),
        ("Click to upgrade", "Klik za nadogradnju"),
        ("Configure", "Konfigurisanje"),
        ("config_acc", "Da biste daljinski kontrolisali radnu površinu, VexeoSoporte-u treba da dodelite \"Accessibility\" prava."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, VexeoSoporte-u treba da dodelite \"Screen Recording\" prava."),
        ...
        ("android_input_permission_tip1", "Da bi daljinski uređaj kontrolisao vaš Android uređaj preko miša ili na dodir, treba da dozvolite VexeoSoporte-u da koristi \"Accessibility\" servis."),
        ("android_input_permission_tip2", "Molimo pređite na sledeću stranicu sistemskih podešavanja, pronađite i unesite [Installed Services], uključite [VexeoSoporte Input] servis."),
        ...
        ("android_open_battery_optimizations_tip", "Ako želite da onemogućite ovu funkciju, molimo idite na sledeću stranicu za podešavanje VexeoSoporte aplikacije, pronađite i uđite u [Battery], isključite [Unrestricted]"),
        ...
        ("Show RustDesk", "Prikazi VexeoSoporte"),
        ("This PC", "Ovaj PC"),
        ("or", "ili"),
        ("Elevate", "Izdigni"),
        ...
        ("config_input", "Da biste upravljali udaljenom radnom površinom tastaturom, potrebno je da dodelite VexeoSoporte-u dozvolu \"Praćenje unosa\"."),
        ("config_microphone", "Da biste govorili na daljinu, potrebno je da dodelite VexeoSoporte-u dozvolu \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "I dalje zahteva da udaljeni korisnik klikne OK na UAC prozoru pokrenutog VexeoSoporte-a."),
        ...
        ("verify_rustdesk_password_tip", "Potvrdi VexeoSoporte lozinku"),
        ...
        ("scam_text1", "Ako razgovarate telefonom sa nekim koga NE poznajete I kome NE VERUJETE, a ko vas je zamolio da koristite VexeoSoporte i pokrenete servis, nemojte nastaviti i odmah prekinite vezu."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Molimo nadogradite VexeoSoporte Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "SELinux je omogućen na vašem uređaju, što može sprečiti VexeoSoporte da radi pravilno kao kontrolisana strana."),
        ...
        ("allow-only-conn-window-open-tip", "Dozvoli konekciju samo ako je VexeoSoporte prozor otvoren"),
        ...
        ("floating_window_tip", "Pomaže da se VexeoSoporte pozadinski servis održi"),
        ...
        ("About RustDesk", "O VexeoSoporte-u"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Molimo nadogradite VexeoSoporte klijent na verziju {} ili noviju na udaljenoj strani!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Podrazumevano, VexeoSoporte proverava sertifikat servera za protokole koji koriste TLS.\nSa omogućenom ovom opcijom, VexeoSoporte će preskočiti korak provere i nastaviti u slučaju neuspele provere."),
        ("Disable UDP", "Onemogući UDP"),
        ("disable-udp-tip", "Kontroliše da li se koristi samo TCP.\nKada je ova opcija omogućena, VexeoSoporte više neće koristiti UDP 21116, umesto toga će se koristiti TCP 21116."),
        ("server-oss-not-support-tip", "NAPOMENA: VexeoSoporte server OSS ne uključuje ovu funkciju."),
