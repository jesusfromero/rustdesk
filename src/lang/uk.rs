...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Підключення до мережі VexeoSoporte..."),
        ...
        ("install_tip", "Через UAC, в деяких випадках VexeoSoporte може працювати некоректно на віддаленому вузлі. Щоб уникнути UAC, натисніть кнопку нижче для встановлення VexeoSoporte в системі"),
        ("Click to upgrade", "Натисніть, щоб перевірити наявність оновлень"),
        ("Configure", "Налаштувати"),
        ("config_acc", "Для віддаленого керування вашою стільницею, вам необхідно надати VexeoSoporte дозволи \"Спеціальні можливості\""),
        ("config_screen", "Для віддаленого доступу до вашої стільниці, вам необхідно надати VexeoSoporte дозволи на \"Запис екрана\""),
        ...
        ("android_input_permission_tip1", "Для того, щоб віддалений пристрій міг керувати вашим Android-пристроєм за допомогою миші або дотику, вам необхідно дозволити VexeoSoporte використовувати службу \"Спеціальні можливості\"."),
        ("android_input_permission_tip2", "Будь ласка, перейдіть на наступну сторінку системних налаштувань, знайдіть та увійдіть у [Встановлені служби], увімкніть службу [VexeoSoporte Input]."),
        ...
        ("Language", "Мова"),
        ("Keep RustDesk background service", "Зберегти фонову службу VexeoSoporte"),
        ...
        ("Show RustDesk", "Показати VexeoSoporte"),
        ("This PC", "Цей ПК"),
        ("or", "чи"),
        ...
        ("config_input", "Для віддаленого керування віддаленою стільницею з клавіатури, вам необхідно надати VexeoSoporte дозволи на \"Відстеження введення\""),
        ("config_microphone", "Для можливості віддаленої розмови, вам необхідно надати VexeoSoporte дозвіл на \"Запис аудіо\""),
        ...
        ("verify_rustdesk_password_tip", "Перевірте пароль VexeoSoporte"),
        ...
        ("scam_text1", "Якщо ви розмовляєте по телефону з кимось, кого НЕ ЗНАЄТЕ чи кому НЕ ДОВІРЯЄТЕ, і ця особа хоче, щоб ви використали VexeoSoporte та запустили службу, не робіть цього та негайно завершіть дзвінок."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Будь ласка, оновіть VexeoSoporte Server Pro до версії {} чи новіше!"),
        ...
        ("selinux_tip", "SELinux увімкнено на вашому пристрої, що може ускладнити для іншої сторони віддалене керування за допомогою VexeoSoporte."),
        ...
        ("powered_by_me", "На основі VexeoSoporte"),
        ...
        ("allow-only-conn-window-open-tip", "Дозволяти підключення лише коли відкрите вікно VexeoSoporte"),
        ...
        ("floating_window_tip", "Допомагає зберегти фонову службу VexeoSoporte"),
        ...
        ("About RustDesk", "Про VexeoSoporte"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Будь ласка, оновіть VexeoSoporte клієнт на віддаленому пристрої до версії {} чи новіше!"),
        ...
        ("allow-insecure-tls-fallback-tip", "За замовчуванням VexeoSoporte перевіряє сертифікат сервера для протоколів, які використовують TLS.\nКоли цей параметр увімкнено, у разі помилки перевірки VexeoSoporte пропустить крок перевірки та продовжить."),
        ("Disable UDP", "Вимкнути UDP"),
        ("disable-udp-tip", "Визначає, чи використовувати лише TCP.\nКоли цей параметр увімкнено, VexeoSoporte більше не використовуватиме UDP 21116, замість нього буде використано TCP 21116."),
        ("server-oss-not-support-tip", "ПРИМІТКА: сервер VexeoSoporte OSS не містить цієї функції."),
