...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "מוכן"),
        ("Established", "מחובר"),
        ("connecting_status", "מתחבר לרשת VexeoSoporte..."),
        ...
        ("install_tip", "בגלל UAC, VexeoSoporte לא יכול לפעול כראוי כצד מרוחק בחלק מהמקרים. כדי להימנע מ-UAC, אנא לחץ על הכפתור למטה כדי להתקין את VexeoSoporte במערכת."),
        ("Click to upgrade", "לחץ כדי לשדרג"),
        ("Configure", "הגדר"),
        ("config_acc", "כדי לשלוט מרחוק בשולחן העבודה שלך, עליך להעניק ל-VexeoSoporte הרשאות \"נגישות\"."),
        ("config_screen", "כדי לגשת מרחוק לשולחן העבודה שלך, עליך להעניק ל-VexeoSoporte הרשאות \"הקלטת מסך\"."),
        ("Installing ...", "מתקין ..."),
        ("Install", "התקן"),
        ("Installation", "התקנה"),
        ...
        ("android_input_permission_tip1", "כדי שמכשיר מרוחק יוכל לשלוט במכשיר האנדרואיד שלך באמצעות עכבר או מגע, עליך לאפשר ל-VexeoSoporte להשתמש בשירות \"נגישות\"."),
        ("android_input_permission_tip2", "אנא עבור לדף הגדרות המערכת הבא, מצא והכנס ל[שירותים מותקנים], הפעל את שירות [VexeoSoporte Input]."),
        ...
        ("Turned off", "מכובה"),
        ("Language", "שפה"),
        ("Keep RustDesk background service", "השאר את שירות הרקע של VexeoSoporte פעיל"),
        ("Ignore Battery Optimizations", "התעלם מאופטימיזציות סוללה"),
        ("android_open_battery_optimizations_tip", "אם ברצונך לבטל תכונה זו, אנא עבור לדף ההגדרות של יישום VexeoSoporte , מצא והיכנס ל[סוללה], ובטל את הסימון מ-[לא מוגבל]"),
        ...
        ("Show RustDesk", "הצג את VexeoSoporte"),
        ("This PC", "מחשב זה"),
        ("or", "או"),
        ...
        ("config_input", "כדי לשלוט בשולחן העבודה המרוחק באמצעות מקלדת, עליך להעניק ל-VexeoSoporte הרשאות \"מעקב קלט\"."),
        ("config_microphone", "כדי לדבר מרחוק, עליך להעניק ל-VexeoSoporte הרשאות \"הקלטת שמע\"."),
        ...
        ("still_click_uac_tip", "עדיין נדרש מהמשתמש המרוחק לאשר את חלון ה-UAC של VexeoSoporte"),
        ...
        ("verify_rustdesk_password_tip", "אמת סיסמת VexeoSoporte"),
        ...
        ("scam_text1", "אם אתה בשיחת טלפון עם מישהו שאינך מכיר ואינך סומך עליו שביקש ממך להשתמש ב-VexeoSoporte ולהתחיל את השירות, אל תמשיך ונתק מיד."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "אנא שדרג את VexeoSoporte Server Pro לגרסה {} או חדשה יותר!"),
        ...
        ("selinux_tip", "SELinux מופעל במכשיר שלך, מה שעלול למנוע מ-VexeoSoporte לפעול כראוי כצד הנשלט."),
        ...
        ("About RustDesk", "אודות VexeoSoporte"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "אנא שדרג את לקוח VexeoSoporte לגרסה {} או חדשה יותר בצד המרוחק!"),
        ...
        ("allow-insecure-tls-fallback-tip", "כברירת מחדל, VexeoSoporte מאמת את אישור השרת עבור פרוטוקולים המשתמשים ב-TLS.\nכאשר אפשרות זו מופעלת, VexeoSoporte יחזור לדילוג על שלב האימות וימשיך במקרה של כשל באימות."),
        ("Disable UDP", "השבת UDP"),
        ("disable-udp-tip", "קובע אם להשתמש ב-TCP בלבד.\nכאשר אפשרות זו מופעלת, VexeoSoporte לא ישתמש יותר ב-UDP 21116, ובמקום זאת ייעשה שימוש ב-TCP 21116."),
        ("server-oss-not-support-tip", "הערה: גרסת ה-OSS של שרת VexeoSoporte אינה כוללת תכונה זו."),
