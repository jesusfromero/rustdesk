...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete VexeoSoporte..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), VexeoSoporte potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare VexeoSoporte a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a VexeoSoporte il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a VexeoSoporte il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a VexeoSoporte di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [VexeoSoporte Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep RustDesk background service", "Mantieni il servizio di VexeoSoporte in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione VexeoSoporte, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show RustDesk", "Visualizza VexeoSoporte"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ("Elevate", "Eleva"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a VexeoSoporte 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a VexeoSoporte."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di VexeoSoporte."),
        ...
        ("verify_rustdesk_password_tip", "Conferma password VexeoSoporte"),
        ...
        ("Exit", "Esci da VexeoSoporte"),
        ("Open", "Apri VexeoSoporte"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare VexeoSoporte e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Aggiorna VexeoSoporte Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di VexeoSoporte come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da VexeoSoporte"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra VexeoSoporte è aperta"),
        ...
        ("floating_window_tip", "Aiuta a mantenere il servizio VexeoSoporte in background."),
        ...
        ("About RustDesk", "Info su VexeoSoporte"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Aggiorna il client VexeoSoporte remoto alla versione {} o successiva!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per impostazione predefinita, VexeoSoporte verifica il certificato del server per i protocolli usando TLS.\nCon questa opzione abilitata, VexeoSoporte salterà il passaggio di verifica e procederà in caso di errore di verifica."),
        ("Disable UDP", "Disabilita UDP"),
        ("disable-udp-tip", "Controlla se usare solo TCP.\nQuando questa opzione è abilitata, VexeoSoporte non userà più UDP 21116, verrà invece usato TCP 21116."),
        ("server-oss-not-support-tip", "Nota: il sistema operativo del server VexeoSoporte non include questa funzionalità."),
