...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "VexeoSoportei võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa VexeoSoporte mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et VexeoSoporte oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb VexeoSoporteile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb VexeoSoporteile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma VexeoSoporteile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [VexeoSoporte Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep RustDesk background service", "Säilita VexeoSoportei taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele VexeoSoportei rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("Show RustDesk", "Kuva VexeoSoporte"),
        ("This PC", "See arvuti"),
        ("or", "või"),
        ("Elevate", "Tõsta"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma VexeoSoporteile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma VexeoSoporteile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud VexeoSoportei kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_rustdesk_password_tip", "Kinnita VexeoSoportei parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul VexeoSoportei kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Palun täienda VexeoSoporte Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib VexeoSoporteil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb VexeoSoporteil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui VexeoSoportei aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada VexeoSoportei taustateenust."),
        ...
        ("About RustDesk", "VexeoSoportei teave"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Täiendage VexeoSoportei klient kaugküljel versioonile {} või uuemale!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Vaikimisi kontrollib VexeoSoporte TLS-i kasutavate protokollide puhul serveri sertifikaati.\nKui see valik on lubatud, jätab VexeoSoporte kontrollimissammu vahele ja jätkab kontrolli ebaõnnestumise korral."),
        ("Disable UDP", "Keela UDP"),
        ("disable-udp-tip", "Määrab, kas kasutada ainult TCP-d.\nKui see valik on lubatud, ei kasuta VexeoSoporte enam UDP 21116, vaid kasutatakse selle asemel TCP 21116."),
        ("server-oss-not-support-tip", "MÄRKUS: VexeoSoportei serveri OSS ei sisalda seda funktsiooni."),
