...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Slogan_tip", "Private remote support by VEXEO Digital Solutions, S.L."),
        ...
        ("install_tip", "Due to UAC, VexeoSoporte can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install VexeoSoporte to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant VexeoSoporte \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant VexeoSoporte \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow VexeoSoporte to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [VexeoSoporte Input] service."),
        ...
        ("doc_mac_permission", "https://vexeo.es"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next VexeoSoporte application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant VexeoSoporte \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant VexeoSoporte \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running VexeoSoporte."),
        ...
        ("verify_rustdesk_password_tip", "Verify VexeoSoporte password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use VexeoSoporte and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade VexeoSoporte Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://vexeo.es"),
        ("display_is_plugged_out_msg", "The display is plugged out, switch to the first display."),
        ("selinux_tip", "SELinux is enabled on your device, which may prevent VexeoSoporte from running properly as controlled side."),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if VexeoSoporte window is open"),
        ...
        ("floating_window_tip", "It helps to keep VexeoSoporte background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the VexeoSoporte client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, VexeoSoporte verifies the server certificate for protocols using TLS.\nWith this option enabled, VexeoSoporte will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, VexeoSoporte will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: VexeoSoporte server OSS doesn't include this feature."),
