...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Prisijungiama prie VexeoSoporte tinklo..."),
        ...
        ("install_tip", "Kai kuriais atvejais UAC gali priversti VexeoSoporte netinkamai veikti nuotoliniame pagrindiniame kompiuteryje. Norėdami apeiti UAC, spustelėkite toliau esantį mygtuką, kad įdiegtumėte VexeoSoporte į savo kompiuterį."),
        ("Click to upgrade", "Spustelėkite, jei norite atnaujinti"),
        ("Configure", "Konfigūruoti"),
        ("config_acc", "Norėdami nuotoliniu būdu valdyti darbalaukį, turite suteikti VexeoSoporte \"prieigos\" leidimus"),
        ("config_screen", "Norėdami nuotoliniu būdu pasiekti darbalaukį, turite suteikti VexeoSoporte leidimus \"ekrano kopija\""),
        ("Installing ...", "Diegiama ..."),
        ("Install", "Diegti"),
        ...
        ("install_daemon_tip", "Norėdami, kad VexeoSoporte startuotų automatiškai, turite ją įdiegti"),
        ...
        ("android_input_permission_tip1", "Kad nuotolinis įrenginys galėtų valdyti Android įrenginį pele arba liesti, turite leisti VexeoSoporte naudoti \"Prieinamumo\" paslaugą."),
        ("android_input_permission_tip2", "Eikite į kitą sistemos nustatymų puslapį, suraskite \"Įdiegtos paslaugos\" ir įgalinkite \"VexeoSoporte įvestis\" paslaugą."),
        ...
        ("Turned off", "Išjungti"),
        ("Language", "Kalba"),
        ("Keep RustDesk background service", "Palikti VexeoSoporte fonine paslauga"),
        ...
        ("Show RustDesk", "Rodyti VexeoSoporte"),
        ...
        ("config_input", "Norėdami valdyti nuotolinį darbalaukį naudodami klaviatūrą, turite suteikti VexeoSoporte leidimus \"Įvesties monitoringas\"."),
        ("config_microphone", "Norėdami kalbėtis su nuotoline puse, turite suteikti VexeoSoporte leidimą \"Įrašyti garsą\"."),
        ...
        ("still_click_uac_tip", "Vis tiek reikia, kad nuotolinis vartotojas paleidžiant VexeoSoporte UAC lange paspaustų \"OK\"."),
        ...
        ("verify_rustdesk_password_tip", "Įveskite kliento VexeoSoporte slaptažodį"),
        ...
        ("scam_text1", "Jei kalbatės telefonu su žmogumi, kurio NEPAŽĮSTATE ir kuriuo NEPASITIKITE, ir jis paprašė jūsų naudoti VexeoSoporte bei paleisti paslaugą, netęskite ir nedelsdami padėkite ragelį."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Prašome atnaujinti VexeoSoporte Server Pro į versiją {} ar naujesnę!"),
        ...
        ("selinux_tip", "Jūsų įrenginyje įjungtas SELinux, kuris gali trukdyti VexeoSoporte tinkamai veikti kaip valdomajai pusei."),
        ...
        ("powered_by_me", "Veikia su VexeoSoporte"),
        ...
        ("allow-only-conn-window-open-tip", "Leisti prisijungti tik tada, kai atidarytas VexeoSoporte langas"),
        ...
        ("floating_window_tip", "Tai padeda išlaikyti VexeoSoporte foninę paslaugą"),
        ...
        ("About RustDesk", "Apie VexeoSoporte"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Prašome atnaujinti nuotolinės pusės VexeoSoporte klientą į {} ar naujesnę versiją!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Pagal numatytuosius nustatymus VexeoSoporte tikrina serverio sertifikatą protokoluose, naudojančiuose TLS.\nĮgalinus šią parinktį, patikros nesėkmės atveju VexeoSoporte praleis patikros veiksmą ir tęs darbą."),
        ("Disable UDP", "Išjungti UDP"),
        ("disable-udp-tip", "Nurodo, ar naudoti tik TCP.\nĮgalinus šią parinktį, VexeoSoporte nebenaudos UDP 21116, vietoj jo bus naudojamas TCP 21116."),
        ("server-oss-not-support-tip", "PASTABA: VexeoSoporte serverio OSS šios funkcijos neturi."),
