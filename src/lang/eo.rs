...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Konektante al la reto VexeoSoporte..."),
        ...
        ("install_tip", "Vi ne uzas instalita versio. Pro limigoj pro UAC, kiel aparato kontrolata, en kelkaj kazoj, ne estos ebla kontroli la muson kaj klavaron aŭ registri la ekranon. Bonvolu alkliku la butonon malsupre por instali VexeoSoporte sur la operaciumo por eviti la demando supre."),
        ("Click to upgrade", "Alklaki por plibonigi"),
        ("Configure", "Konfiguri"),
        ("config_acc", "Por uzi vian foran aparaton, bonvolu doni la permeson \"alirebleco\" al VexeoSoporte."),
        ("config_screen", "Por uzi vian foran aparaton, bonvolu doni la permeson \"ekranregistrado\" al VexeoSoporte."),
        ...
        ("android_input_permission_tip1", "Por ke fora aparato regu vian Android-aparaton per muso aŭ tuŝo, vi devas permesi al VexeoSoporte uzi la servon \"Alirebleco\"."),
        ("android_input_permission_tip2", "Bonvolu iri al la sekva paĝo de sistemaj agordoj, trovi kaj eniri [Instatajn Servojn], ŝalti la servon [VexeoSoporte Enigo]."),
        ...
        ("Language", "Lingvo"),
        ("Keep RustDesk background service", "Tenu VexeoSoporte fonan servon"),
        ("Ignore Battery Optimizations", "Ignoru Bateria Optimumigojn"),
        ("android_open_battery_optimizations_tip", "Se vi volas malŝalti ĉi tiun funkcion, bonvolu iri al la sekva paĝo de agordoj de la aplikaĵo de VexeoSoporte, trovi kaj eniri [Baterio], Malmarku [Senrestrikta]"),
        ...
        ("Show RustDesk", "Montri VexeoSoporte"),
        ...
        ("config_input", "Por kontroli la foran labortablon per klavaro, vi devas doni al VexeoSoporte permeson \"Eniga Monitorado\"."),
        ("config_microphone", "Por paroli fore, vi devas doni al VexeoSoporte permeson \"Registri Sonon\"."),
        ...
        ("still_click_uac_tip", "Ankoraŭ postulas ke la fora uzanto alklaku Bone en la UAC-fenestro de la funkcianta VexeoSoporte."),
        ...
        ("verify_rustdesk_password_tip", "Kontroli VexeoSoporte-pasvorton"),
        ...
        ("scam_text1", "Se vi telefonas kun iu kiun vi NE konas KAJ FIDAS, kiu petis vin uzi VexeoSoporte kaj komenci la servon, ne daŭrigu kaj tuj malŝaltu la telefonon."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Bonvolu ĝisdatigi VexeoSoporte Server Pro al versio {} aŭ pli nova!"),
        ...
        ("selinux_tip", "SELinux estas ebligita sur via aparato, kio povas malhelpi VexeoSoporte funkcii ĝuste kiel kontrolata flanko."),
        ...
        ("powered_by_me", "Funkciigita de VexeoSoporte"),
        ...
        ("allow-only-conn-window-open-tip", "Permesi konekton nur se la fenestro de VexeoSoporte estas malfermita"),
        ...
        ("floating_window_tip", "Ĝi helpas teni la fonan servon de VexeoSoporte"),
        ...
        ("About RustDesk", "Pri VexeoSoporte"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Bonvolu ĝisdatigi la VexeoSoporte-klienton al versio {} aŭ pli nova ĉe la fora flanko!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Implicite, VexeoSoporte kontrolas la servilan atestilon por protokoloj uzantaj TLS.\nKun ĉi tiu opcio ebligita, VexeoSoporte retrokadros al preterlaso de la kontrola paŝo kaj daŭrigos en kazo de kontrola malsukceso."),
        ("Disable UDP", "Malebligi UDP"),
        ("disable-udp-tip", "Regas ĉu uzi nur TCP.\nKiam ĉi tiu opcio estas ebligita, VexeoSoporte ne plu uzos UDP 21116, TCP 21116 estos uzata anstataŭe."),
        ("server-oss-not-support-tip", "NOTU: VexeoSoporte-servilo OSS ne inkluzivas ĉi tiun funkcion."),
